"""Ce code c'est pour faire le planning personnalisé en affichant les perms dans un tableau, et pour la première seulement ca affiche le planning de la journée"""
